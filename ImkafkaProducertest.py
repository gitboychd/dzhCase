...
"""IM kafka"""
# bootstrapServers = "10.15.108.87:9092,10.15.108.88:9092,10.15.108.90:9092"
# bootstrapServers = "10.15.108.24:9092,10.15.108.93:9092,10.15.108.94:9092"   # imservice
# bootstrapServers = "10.15.108.87:9092,10.15.108.88:9092,10.15.108.90:9092"   # pyq
...
bootstrapServers = "10.15.144.191:9092,10.15.144.193:9092,10.15.144.194:9092"  # 大数据,内容号,crm
...
while i <= n:
    ...
    # _data = {"code":"SH605399","name":"晨光新材","account":"20202030","type":1}
    ...
    # """股吧群收费验证开户"""
    # p_topic = "kaihuTopic"
    # _data = {"MarketCode":"3950","MobileFormat":"13013001300","UserName":"hxtest-q111","CreateTime":"2022-02-15 12:00:01","Remark":{"currentstep":"U","tradeNo":"19000","operateTime":"2022-02-15 12:00:00"}}


    # """慧信app登录"""
    # p_topic = "userlogin"
    # _data = {"realuname":"chdtest001","loginfo":" [CWorkThread.cpp:7670] p12909-t13138 SubType1300_UserLogin END","agent":{"hostname":"chdtest001","type":"filebeat","id":"975a5c71-878c-41c4-9987-9b494d292679","version":"9.67","ephemeral_id":"95ee24f0-1084-48f2-bb59-2fd4e514af21"},"delay":"10","device_id":"2e759307-a6bc-409e-a057-8060b5d7d492","figured":"","input":{"type":"log"},"vbar":"81221734","token":"oxlqyDzXInUBd3j0nzHr0ipoE7KtyKapxTyN5AFNEUY.1727723629","ecs":{"version":"10.01"},"privileges":"0x8927F","platform_type":"14","fields":{"appname":"AccountServer","serverip":"10.33.2.44"},"vuserinfo":"","nickname":"发条橙1","QXD":{},"result":"0","rand_str":"91586942","platform":"Gphone","token_expire":84600,"logdate":"20230811 10:18:11.734","log":{"offset":540006794,"file":{"path":"/home/v4/log/Run.log.20230531160826"}},"uname":"chdtest001","hk_l2_expired":0,"teenagers":"false","vuser":"false","@version":"1","login_time":"2023-08-11 10:18:11","digital":{"digitalAvatar":"false","prodNum":-1},"version":"10.01","login_method":"auto","ATTR":"","@timestamp":"2023-08-11T17:10:11.734Z","host":{"name":"chdtest001"}}
    # """惠友圈发帖子发送红点消息"""
    # # p_topic = "NOTIFY_DATA"
    # p_topic = "WAIT_VERIFY_DATA"
    # _data = {"notifyMsg":"","operateUserId":"chdtest001","notifyUserId":"","type":"POST_PUBLISH_MSG_NOTIFY","postId":"652cf6ee8190670835dfa78c","scope":"public","title":"['港股恒生1111']","time":"2023-10-16 17:17:47"}
    # # 单聊消息
    # p_topic = "gwim.callback"
    # _data = {"CallbackCommand":"C2C.CallbackAfterSendMsg","From_Account":"chdtest001","To_Account":"chatgpt","contact":"false","fromDzhAc":"chatgpt","msgBody":[{"MsgContent":{"Text":"了解一下大智慧"},"MsgType":"TIMTextElem"}],"source":"RESTAPI","t":1692065771481,"toDzhAc":"8834749"}
    #

    # # """1v1vip标识"""
    # p_topic = "im_user_vip_topic"
    # _data = {"account":"20202024","endTime":"2023-11-27","productId":335,"quasiVip":0,"status":1,"updateTime":1701312455000,"vip":1}

    # """AI欢迎语"""
    # p_topic = "user_welcome_content_topic"
    # _data = {"assistTyp":0,"dzhAccountId":"pay测试00091","id":0,"type":"1","welcomContent":"欢迎欢迎您欢迎您112"}

    # """AI关键词匹配"""
    p_topic = "user_keyword_topic"
    _data = {"assistTyp":1,"createTime":1704162815000,"dzhAccountId":"pay测试00091","id":1,"keyWord":"2","matchAnswer":"2","type":"1","updateTime":1704162815000}
    #
    # # """和AI研究员发言"""
    # p_topic = "gwim.callback"
    # _data = {"CallbackCommand":"C2C.CallbackAfterSendMsg","From_Account":"20202023","MsgSeq":1989767370,"To_Account":"chatgpt","contact":"false","fromDzhAc":"20202023","msgBody":[{"MsgContent":{"Text":"你好"},"MsgType":"TIMTextElem"}],"source":"iOS","t":1702887331519,"toDzhAc":"chatgpt"}

    # """1v1vip销售"""
    # p_topic = "im_user_seller_topic"
    # _data = {"account":"chdtest002","endTime":"2023-05-10","productId":335,"quasiVip":0,"status":1,"updateTime":1699513293001,"vip":1}



    # """内容号社群加人191"""
    # p_topic = "bd_content_tag"
    # create_time = time.time()
    # for a in range(2000,3000):
    #     account = "hxtest-q"+str(a);
    #     _data = {"username":account,"operate":"add","tag":"965_all","create_time":"2023-07-21 16:30:00"}
        # result = producer.send(topic=p_topic, value=json.dumps(_data, ensure_ascii=False).encode("utf8"))
        # print(json.dumps(_data, ensure_ascii=False))
    # _data = {"username": "qikaiyang001", "operate": "add", "tag": "971_all", "create_time": "2023-12-06 10:39:00"}
    # """内容号发消息-白名单"""
    # p_topic = "ai_cas_im_push"
    # _data = {"msg_id":"ns:1689297271774:datanews-43074","msg_type":"1072","sender":"dzhhxnrh104","send_type":"user","send_scope":["chdtest001","1242267","hxtest-q258","hxtest-q896","hxtest-q1226","hxtest-q951","hxtest-q158","hxtest-q116"],"no_unread":0,"showimage":"https:\/\/dzhimage.oss-cn-hangzhou.aliyuncs.com\/avatar\/24fc9bd0657c2c2fb05c46309e7eff3146970df7","data":{"id":"datanews-43074","pubdate":"2023-07-14 09:13:43","type":2,"text":"【融资融券1】索菲亚07月113日融资净买入22.07万元，上一交易日融资净偿还28.28万元","author":"数据中心","username":"","usericon":"","usertag":"","url":"dzh_browser_url&goto=0&screen=466&topNewsId=datanews-43074","typestring":"资讯","showimage":"https:\/\/dzhimage.oss-cn-hangzhou.aliyuncs.com\/avatar\/0651fc64c7fc311004b889f110a1cef6b4985bbb"},"ts":1689297271819}

    # """内容号发消息-所有人"""
    # p_topic = "ai_cas_im_push"
    # _data = {"msg_id":"fd:1689303309981:lineposts-64b0b8e22397419a71ccd93d","msg_type":"1072","sender":"dzhhxnrh103","send_type":"all","send_scope":[],"no_unread":0,"showimage":"https:\/\/dzhimage.oss-cn-hangzhou.aliyuncs.com\/avatar\/8011767b0c3c23dbcdc4d7b1d5ad5f49bce44eb9","data":{"id":"lineposts-64b0b8e22397419a71ccd93d","pubdate":"2023-07-14 10:54:26","type":4,"text":"朋友圈文章1","author":"974489","username":"几句话咔咔","usericon":"https:\/\/dzhimage.oss-cn-hangzhou.aliyuncs.com\/avatar\/f150dc16b772ed94a1a0c04ec1021e25c0dd197f","usertag":"","url":"dzh_browser_url&goto=0&screen=353&showType=1","typestring":"慧友圈","showimage":"https:\/\/dzhimage.oss-cn-hangzhou.aliyuncs.com\/avatar\/0651fc64c7fc311004b889f110a1cef6b4985bbb"},"ts":1689303310015}
    #
    #
...
# consumerTopic = "STOCK_GROUP_CREATE"  # WAIT_VERIFY_DATA  NOTIFY_DATA  im_invite im_card_used  WAIT_SAVE_DATA txim_back_service
