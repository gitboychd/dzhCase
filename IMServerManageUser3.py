...
if __name__ == "__main__":
    ...
    ModifyGroupParams = dict()
    ModifyGroupParams["GroupId"] = "6337981"
    ModifyGroupParams["FaceUrl"] = "https://newmnews.gw.com.cn/wap/data/im/shop/images/20201229102509.jpg"
    modify_group_base_inforesponse = im_request.request_send(modify_group_base_info, url_params, ModifyGroupParams)
