...
if __name__ == "__main__":
    ...
    SDKAPPID = 1400007088
    ACCTYPE = 2815
    sig = "eJw9j91Og0AQhV*l2duq2R*WBZNeQNOobUlUEMQbguyiU1K6Ybe1rfHdFQydy-OdmTnnGyXr*MbCVqHbCSIuFoxRIRx0NRkISNVaqEF1PZfnz*tSbqEdcVlVu31rC3vSwwHqET4yAx*9FC2e5g-3rcwcd5m-pAHVq41tfH63oE1*njokNmxdGbp8IwEPRBRAyI6vkR8*vodpsspywabzGtuOQ5BmPjznLs*STcxEvD98zWaXKFqDLEpbsE72f0f9oDoDu3ZIhwknFF-KGdkUw9rQ3cF-I7DnjVgdNXSqKGv7354RgnsT*vkFaClYXA__"
    ...
    # 自定义消息
    CustomMsgData = {"userAction": 1014, "actionParam": {
        "data": {"md5": "79243f2217f313fedf41d5d381eb280c", "ext": "jpg", "h": 226, "size": 33439, "w": 450,
                 "name": "图⽚发送于2018-07-18 19:21",
                 "url": "https://newmnews.gw.com.cn/uploaded/tim/2018/07/18/5b4f229de138230800d7c939.jpg"}}}
    ...
    FriendCheckParams["From_Account"] = "dzhkf80101"  # lsym
    FriendCheckParams["To_Account"] = ["13969275666"]  # 110569450
    ...
    FriendAddSubParams["To_Account"] = "20202030"
    ...
    # f = open('rd_robot.txt', encoding='utf-8')
    # result = ['123']
    ...
    #     print(result)
    #     FriendAddParams["From_Account"] = result[0]
    #     print(FriendAddParams)
    #     friend_check_response = im_request.request_send(friend_add_url, url_params, FriendAddParams)
    #     # result.sort()  # 排序结果
    ...
    # print(result)
    for a in result:
        FriendAddParams["From_Account"] = a
        print(a)
        print(FriendAddParams)
        friend_check_response = im_request.request_send(friend_add_url, url_params, FriendAddParams)
        # result.sort()  # 排序结果
    ...
    # count = 0
    # for item in collection.find({}).limit(2500):
    ...
    GetNoSpeakingParams["Get_Account"] = "wxvb68761272"  # dzh155441977  262310025  625925136
    ...
    PortraitGetParams["To_Account"] = ["kh167628333"]  # 178554
